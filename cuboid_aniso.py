...
dt_l.append(dimtags)
# print(dimtags)
dimtags = gmsh.model.occ.extrude([(1, dimtags[1][1])], 0, len_dy, 0, n_dy, h_dy, recombine=True) # heights 层高（百分比，累计高度）
dt_l.append(dimtags)
# print(dimtags)
dimtags = gmsh.model.occ.extrude([(2, dimtags[1][1])], 0, 0, len_dz, n_dz, h_dz, recombine=True) # heights 层高（百分比，累计高度）
dt_l.append(dimtags)
print(dimtags)
